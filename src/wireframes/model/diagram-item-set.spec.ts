...
describe('Diagram Item Set', () => {
    ...
    const root2 = DiagramItem.createShape({ id: '2', renderer: shapes.id.button, isLocked: true });
    const child1 = DiagramItem.createShape({ id: '3', renderer: shapes.id.button });
    const child2 = DiagramItem.createShape({ id: '4', renderer: shapes.id.button, isLocked: true });
